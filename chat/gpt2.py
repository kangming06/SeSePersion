...
class ChatBot:
    def top_k_top_p_filtering(self,logits, top_k=0, top_p=0.0, filter_value=-float('Inf')):
        ...
        return logits
    def __init__(self,vocab_path="vocab/vocab.txt",model_path='model',max_history_len=3,max_len=25,repetition_penalty=1.0,temperature=1.0,topk=8,topp=0.0):
        self.tokenizer = BertTokenizerFast(vocab_file=vocab_path, sep_token="[SEP]", pad_token="[PAD]",cls_token="[CLS]")
        self.model=GPT2LMHeadModel.from_pretrained(model_path).to("cpu")
        self.model.eval()
        self.history={}
    ...
    def chat(self,text,id):
        ...
        for _ in range(self.max_len):
            ...
            filtered_logits = self.top_k_top_p_filtering(next_token_logits, top_k=self.topk, top_p=self.topp)
            ...
            # his_text = self.tokenizer.convert_ids_to_tokens(curr_input_tensor.tolist())
